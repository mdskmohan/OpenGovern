...
from opengovern_connectors.configuration.common import ConfigModel, TransformerSemanticsConfigModel
...
from opengovern_connectors.metadata.urns import StructuredPropertyUrn, TagUrn
