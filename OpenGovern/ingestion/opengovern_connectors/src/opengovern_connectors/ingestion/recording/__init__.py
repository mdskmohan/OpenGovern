...
def __getattr__(name: str) -> object:
    ...
    if name == "RecordingConfig":
        ...
        from opengovern_connectors.ingestion.recording.recorder import IngestionRecorder

        return IngestionRecorder
    elif name == "IngestionReplayer":
        from opengovern_connectors.ingestion.recording.replay import IngestionReplayer
