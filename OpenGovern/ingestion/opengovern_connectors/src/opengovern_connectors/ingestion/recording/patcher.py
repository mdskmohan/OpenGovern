...
from opengovern_connectors.ingestion.recording.db_proxy import (
    ConnectionProxy,
    QueryRecorder,
    ReplayConnection,
)
from opengovern_connectors.ingestion.recording.sqlalchemy_events import (
    ...
    def _create_client_wrapper(self, original_class: type) -> type:  # noqa: C901
        ...
        class WrappedClient(original_class):  # type: ignore
            ...
            def list_datasets(self, *args: Any, **kwargs: Any) -> Any:
                ...
                from opengovern_connectors.ingestion.recording.db_proxy import QueryRecording
