...
from opengovern_connectors.ingestion.source.powerbi.rest_api_wrapper import data_resolver
...
from opengovern_connectors.ingestion.source.powerbi.rest_api_wrapper.data_resolver import (
    AdminAPIResolver,
    RegularAPIResolver,
)
