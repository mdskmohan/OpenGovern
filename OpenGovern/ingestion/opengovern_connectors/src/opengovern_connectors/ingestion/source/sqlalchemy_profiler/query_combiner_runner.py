...
if TYPE_CHECKING:
    ...
    from opengovern_connectors.ingestion.source.sqlalchemy_profiler.base_adapter import (
        PlatformAdapter,
    )
    from opengovern_connectors.utilities.sqlalchemy_query_combiner import SQLAlchemyQueryCombiner
