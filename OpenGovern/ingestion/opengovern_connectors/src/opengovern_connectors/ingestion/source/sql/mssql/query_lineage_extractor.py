...
from opengovern_connectors.ingestion.source.sql.mssql.query import MSSQLQuery
...
if TYPE_CHECKING:
    ...
    from opengovern_connectors.ingestion.source.sql.mssql.source import SQLServerConfig
