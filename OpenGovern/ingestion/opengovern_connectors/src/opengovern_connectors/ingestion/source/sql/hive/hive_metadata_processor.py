...
from opengovern_connectors.ingestion.source.sql.hive.exceptions import InvalidDatasetIdentifierError
from opengovern_connectors.ingestion.source.sql.hive.storage_lineage import HiveStorageLineage
from opengovern_connectors.ingestion.source.sql.sql_common import SqlWorkUnit, get_schema_metadata
...
from opengovern_connectors.metadata.com.linkedin.pegasus2avro.common import StatusClass
...
from opengovern_connectors.metadata.com.linkedin.pegasus2avro.schema import SchemaField
...
if TYPE_CHECKING:
    from opengovern_connectors.ingestion.source.sql.hive.hive_data_fetcher import HiveDataFetcher
    from opengovern_connectors.ingestion.source.sql.hive.hive_metastore_source import (
        HiveMetastore,
...
class HiveMetadataProcessor:
    ...
    def _get_presto_view_datasets(self, db_name: str) -> Iterable[ViewDataset]:
        ...
        """
        from opengovern_connectors.ingestion.source.sql.hive.hive_sql_fetcher import (
    ...
    def process_views(
        ...
        Args:
            db_name: Database/catalog name for URN generation
        """
        from opengovern_connectors.ingestion.source.sql.hive.hive_metastore_config import (
