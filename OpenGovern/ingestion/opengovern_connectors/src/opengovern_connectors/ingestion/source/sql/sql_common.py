...
from opengovern_connectors.ingestion.api.decorators import capability
...
from opengovern_connectors.ingestion.api.source_protocols import MetadataWorkUnitIterable
...
from opengovern_connectors.ingestion.source.sql.sql_config import SQLCommonConfig
...
from opengovern_connectors.ingestion.source.sql.sqlalchemy_data_reader import (
...
from opengovern_connectors.telemetry import telemetry
from opengovern_connectors.utilities.registries.domain_registry import DomainRegistry
from opengovern_connectors.utilities.sqlalchemy_type_converter import (
    get_native_data_type_for_sqlalchemy_type,
)
from opengovern_connectors.utilities.urns.field_paths import get_simple_field_path_from_v2_field_path

if TYPE_CHECKING:
    from opengovern_connectors.ingestion.source.ge_data_profiler import (
        DatahubGEProfiler,
        GEProfilerRequest,
    )
...
class SQLAlchemySource(StatefulIngestionSourceBase, TestableSource):
    ...
    def get_profiler_instance(
        ...
        if self.config.profiling.method == "sqlalchemy":
            ...
            from opengovern_connectors.ingestion.source.ge_data_profiler import DatahubGEProfiler
    ...
    def loop_profiler_requests(
        ...
        from opengovern_connectors.ingestion.source.ge_data_profiler import GEProfilerRequest
