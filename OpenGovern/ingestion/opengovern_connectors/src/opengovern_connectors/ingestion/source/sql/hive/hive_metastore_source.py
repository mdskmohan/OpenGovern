...
from opengovern_connectors.ingestion.source.sql.hive.hive_metastore_report import (
...
class HiveMetastoreSource(StatefulIngestionSourceBase, TestableSource):
    ...
    def __init__(self, config: HiveMetastore, ctx: PipelineContext) -> None:
        ...
        if config.connection_type == HiveMetastoreConnectionType.sql:
            ...
            from opengovern_connectors.ingestion.source.sql.hive.hive_thrift_fetcher import (
                ThriftDataFetcher,
            )
    ...
    def test_connection(config_dict: dict) -> TestConnectionReport:
        ...
        try:
            ...
            if config.connection_type == HiveMetastoreConnectionType.thrift:
                ...
                from opengovern_connectors.ingestion.source.sql.hive.hive_thrift_client import (
    ...
    def get_workunits_internal(self) -> Iterable[MetadataWorkUnit]:
        ...
        from opengovern_connectors.ingestion.source.sql.hive.hive_metadata_processor import (
