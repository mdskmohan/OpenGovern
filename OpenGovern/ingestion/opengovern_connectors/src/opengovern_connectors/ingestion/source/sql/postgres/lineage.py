...
from opengovern_connectors.ingestion.source.sql.postgres.query import PostgresQuery
...
if TYPE_CHECKING:
    ...
    from opengovern_connectors.ingestion.source.sql.postgres.source import PostgresConfig
    from opengovern_connectors.ingestion.source.sql.sql_common import SQLSourceReport
