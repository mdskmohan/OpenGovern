...
from opengovern_connectors.emitter.mcp_builder import ContainerKey, ProjectIdKey, gen_containers
...
from opengovern_connectors.metadata.schema_classes import BrowsePathEntryClass, BrowsePathsV2Class
