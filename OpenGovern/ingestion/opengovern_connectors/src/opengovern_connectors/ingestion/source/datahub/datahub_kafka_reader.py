...
from opengovern_connectors.ingestion.source.datahub.state import PartitionOffset
from opengovern_connectors.metadata.schema_classes import MetadataChangeLogClass
