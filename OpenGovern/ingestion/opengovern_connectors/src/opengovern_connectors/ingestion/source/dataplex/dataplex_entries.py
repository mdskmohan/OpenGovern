...
from opengovern_connectors.ingestion.source.dataplex.dataplex_helpers import (
    EntryDataTuple,
    make_audit_stamp,
    parse_entry_fqn,
)
from opengovern_connectors.ingestion.source.dataplex.dataplex_properties import (
    extract_entry_custom_properties,
)
from opengovern_connectors.ingestion.source.dataplex.dataplex_schema import (
