...
from opengovern_connectors.ingestion.api.source import CapabilityReport, Source, SourceReport
...
if TYPE_CHECKING:
    from opengovern_connectors.ingestion.source.unstructured.chunking_config import EmbeddingConfig
...
class DocumentChunkingSource(Source):
    ...
    def _process_event_driven(self) -> Iterable[MetadataWorkUnit]:
        ...
        from opengovern_connectors.ingestion.source.unstructured.event_consumer import (
