...
from opengovern_connectors.ingestion.source.abs.config import DataLakeSourceConfig, PathSpec
from opengovern_connectors.ingestion.source.abs.report import DataLakeSourceReport
