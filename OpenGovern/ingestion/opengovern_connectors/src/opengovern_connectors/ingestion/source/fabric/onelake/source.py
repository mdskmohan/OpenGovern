...
from opengovern_connectors.ingestion.source.fabric.common.auth import FabricAuthHelper
from opengovern_connectors.ingestion.source.fabric.common.urn_generator import (
    make_lakehouse_name,
    make_schema_name,
    make_table_name,
    make_warehouse_name,
...
from opengovern_connectors.ingestion.source.fabric.onelake.client import OneLakeClient
from opengovern_connectors.ingestion.source.fabric.onelake.config import FabricOneLakeSourceConfig
from opengovern_connectors.ingestion.source.fabric.onelake.constants import (
    DEFAULT_SCHEMA_SCHEMALESS_LAKEHOUSE,
)
from opengovern_connectors.ingestion.source.fabric.onelake.models import (
    FabricColumn,
    FabricLakehouse,
    FabricTable,
    FabricWarehouse,
...
from opengovern_connectors.ingestion.source.fabric.onelake.report import (
        ...
        try:
            ...
            if self.config.extract_schema.enabled and self.config.sql_endpoint:
                if not tables:
                    ...
                    try:
                        from opengovern_connectors.ingestion.source.fabric.onelake.schema_client import (
