...
if TYPE_CHECKING:
    from opengovern_connectors.ingestion.source.fabric.common.base_client import BaseFabricClient

from opengovern_connectors.ingestion.source.fabric.common.auth import (
    SQL_ANALYTICS_ENDPOINT_SCOPE,
    FabricAuthHelper,
)
from opengovern_connectors.ingestion.source.fabric.onelake.config import SqlEndpointConfig
from opengovern_connectors.ingestion.source.fabric.onelake.models import FabricColumn
from opengovern_connectors.ingestion.source.fabric.onelake.schema_report import (
