...
from opengovern_connectors.configuration.common import ConfigurationError
...
from opengovern_connectors.ingestion.source.sigma.config import (
    PlatformDetail,
    SigmaSourceConfig,
    SigmaSourceReport,
    WorkspaceCounts,
)
from opengovern_connectors.ingestion.source.sigma.data_classes import (
    Element,
    Page,
    SigmaDataset,
    Workbook,
...
from opengovern_connectors.ingestion.source.sigma.sigma_api import SigmaAPI
