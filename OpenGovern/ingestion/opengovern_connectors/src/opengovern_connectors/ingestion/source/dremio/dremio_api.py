...
from opengovern_connectors.ingestion.source.dremio.dremio_config import DremioSourceConfig
...
from opengovern_connectors.ingestion.source.dremio.dremio_sql_queries import DremioSQLQueries
from opengovern_connectors.utilities.perf_timer import PerfTimer

if TYPE_CHECKING:
    from opengovern_connectors.ingestion.source.dremio.dremio_entities import DremioContainer
