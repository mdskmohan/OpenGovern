...
from opengovern_connectors.configuration.connection_resolver import auto_connection_resolver
...
from opengovern_connectors.ingestion.source.snowflake.oauth_config import (
    OAuthConfiguration,
    OAuthIdentityProvider,
)
from opengovern_connectors.ingestion.source.snowflake.oauth_generator import OAuthTokenGenerator
from opengovern_connectors.ingestion.source.sql.sqlalchemy_uri import make_sqlalchemy_uri
from opengovern_connectors.utilities.config_clean import (
    remove_protocol,
    remove_suffix,
