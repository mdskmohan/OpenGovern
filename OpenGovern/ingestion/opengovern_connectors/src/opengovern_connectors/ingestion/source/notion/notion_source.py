...
from opengovern_connectors.ingestion.source.notion.notion_config import NotionSourceConfig
from opengovern_connectors.ingestion.source.notion.notion_report import NotionSourceReport
...
class NotionSource(StatefulIngestionSourceBase, TestableSource):
    ...
    **Embedding generation failures:**
    ...
    def _create_document_entity(
        ...
        from opengovern_connectors.metadata.schema_classes import DataPlatformInstanceClass
