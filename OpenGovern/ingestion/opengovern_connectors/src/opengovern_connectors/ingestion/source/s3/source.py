...
from opengovern_connectors.ingestion.source.aws.s3_boto_utils import (
    get_s3_tags,
    list_folders_path,
...
from opengovern_connectors.ingestion.source.data_lake_common.data_lake_utils import (
    ContainerWUCreator,
    add_partition_columns_to_schema,
)
from opengovern_connectors.ingestion.source.data_lake_common.object_store import (
    create_object_store_adapter,
)
from opengovern_connectors.ingestion.source.data_lake_common.path_spec import (
    FolderTraversalMethod,
    PathSpec,
)
from opengovern_connectors.ingestion.source.s3.config import DataLakeSourceConfig
from opengovern_connectors.ingestion.source.s3.report import DataLakeSourceReport
from opengovern_connectors.ingestion.source.schema_inference import avro, csv_tsv, json, parquet
from opengovern_connectors.ingestion.source.schema_inference.base import SchemaInferenceBase
...
from opengovern_connectors.metadata.com.linkedin.pegasus2avro.common import TimeStamp
...
from opengovern_connectors.telemetry import stats, telemetry
...
class S3Source(StatefulIngestionSourceBase):
    ...
    def __init__(self, config: DataLakeSourceConfig, ctx: PipelineContext):
        ...
        if config.is_profiling_enabled():
            ...
            try:
                from opengovern_connectors.ingestion.source.s3.profiling import SparkProfiler
