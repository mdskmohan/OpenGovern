...
from opengovern_connectors.emitter.mcp_builder import add_entity_to_container, gen_containers
...
from opengovern_connectors.ingestion.source.qlik_sense.config import (
    Constant,
    PlatformDetail,
    QlikSourceConfig,
    QlikSourceReport,
)
from opengovern_connectors.ingestion.source.qlik_sense.data_classes import (
    FIELD_TYPE_MAPPING,
...
from opengovern_connectors.ingestion.source.qlik_sense.qlik_api import QlikAPI
