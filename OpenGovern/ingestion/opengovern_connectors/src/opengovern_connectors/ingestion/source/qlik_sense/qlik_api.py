...
from opengovern_connectors.ingestion.source.qlik_sense.config import Constant, QlikSourceConfig
...
from opengovern_connectors.ingestion.source.qlik_sense.websocket_connection import WebsocketConnection
