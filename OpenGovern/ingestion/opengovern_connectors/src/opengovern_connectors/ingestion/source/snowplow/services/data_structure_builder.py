...
from opengovern_connectors.ingestion.source.snowplow.utils.schema_parser import SnowplowSchemaParser
...
if TYPE_CHECKING:
    ...
    from opengovern_connectors.ingestion.source.snowplow.services.field_tagging import FieldTagContext
