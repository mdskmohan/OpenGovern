...
from opengovern_connectors.ingestion.source.snowplow.enrichment_lineage.registry import (
...
from opengovern_connectors.ingestion.source.snowplow.services.field_tagging import FieldTagger
...
if TYPE_CHECKING:
    ...
    from opengovern_connectors.ingestion.source.snowplow.models.snowplow_models import Pipeline
