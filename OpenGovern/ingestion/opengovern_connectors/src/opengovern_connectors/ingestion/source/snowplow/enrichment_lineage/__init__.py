...
Usage:
    from opengovern_connectors.ingestion.source.snowplow.enrichment_lineage import (
...
from opengovern_connectors.ingestion.source.snowplow.enrichment_lineage.extractors import (
