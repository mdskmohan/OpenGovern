...
from opengovern_connectors.api.entities.dataset.dataset import Dataset
from opengovern_connectors.api.entities.external.lake_formation_external_entites import (
    LakeFormationTag,
)
from opengovern_connectors.configuration.common import AllowDenyPattern
from opengovern_connectors.configuration.source_common import DatasetSourceConfigMixin
...
from opengovern_connectors.ingestion.api.report import EntityFilterReport
...
from opengovern_connectors.ingestion.source.aws.aws_common import AwsSourceConfig
from opengovern_connectors.ingestion.source.aws.platform_resource_repository import (
...
from opengovern_connectors.ingestion.source.aws.tag_entities import (
...
from opengovern_connectors.ingestion.source.glue_profiling_config import GlueProfilingConfig
...
from opengovern_connectors.ingestion.source_config.operation_config import is_profiling_enabled
from opengovern_connectors.metadata.com.linkedin.pegasus2avro.common import Status, SubTypes
...
from opengovern_connectors.utilities.delta import delta_type_to_hive_type
...
from opengovern_connectors.utilities.urns.error import InvalidUrnError
