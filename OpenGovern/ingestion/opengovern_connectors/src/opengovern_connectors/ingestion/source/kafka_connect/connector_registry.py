...
class ConnectorRegistry:
    ...
    def _get_source_connector(
        ...
        from opengovern_connectors.ingestion.source.kafka_connect.source_connectors import (
    ...
    def _get_sink_connector(
        ...
        from opengovern_connectors.ingestion.source.kafka_connect.sink_connectors import (
...
class _GenericConnector(BaseConnector):
    ...
    def extract_lineages(self) -> List[KafkaConnectLineage]:
        ...
        from opengovern_connectors.ingestion.source.kafka_connect.common import KafkaConnectLineage
