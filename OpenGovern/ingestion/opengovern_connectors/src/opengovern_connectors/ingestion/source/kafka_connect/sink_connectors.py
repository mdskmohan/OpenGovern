...
from opengovern_connectors.ingestion.source.sql.sqlalchemy_uri_mapper import (
...
class BigQuerySinkConnector(BaseConnector):
    ...
    def get_dataset_for_topic_v1(self, topic: str, parser: BQParser) -> Optional[str]:
        from opengovern_connectors.ingestion.source.kafka_connect.pattern_matchers import (
            JavaRegexMatcher,
        )
