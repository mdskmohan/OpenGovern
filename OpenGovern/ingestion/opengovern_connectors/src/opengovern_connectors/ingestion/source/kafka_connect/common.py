...
from opengovern_connectors.ingestion.source.kafka_connect.config_constants import (
    parse_comma_separated_list,
)
from opengovern_connectors.ingestion.source.kafka_connect.pattern_matchers import JavaRegexMatcher
from opengovern_connectors.ingestion.source.kafka_connect.transform_plugins import (
...
class ConnectorManifest:
    ...
    def get_topics_from_config(
        ...
        from opengovern_connectors.ingestion.source.kafka_connect.connector_registry import (
            ConnectorRegistry,
        )
