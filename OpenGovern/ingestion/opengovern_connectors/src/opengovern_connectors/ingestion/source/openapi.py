...
from opengovern_connectors.configuration.common import ConfigModel, TransparentSecretStr
from opengovern_connectors.emitter.mce_builder import make_dataset_urn, make_tag_urn
...
from opengovern_connectors.ingestion.source.openapi_parser import (
...
class APISource(Source, ABC):
    ...
    def _extract_schema_from_endpoint_data(
        ...
        if "data" in endpoint_dets:
            ...
            from opengovern_connectors.ingestion.source.openapi_parser import flatten2list
