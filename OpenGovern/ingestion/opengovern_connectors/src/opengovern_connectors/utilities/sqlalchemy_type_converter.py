...
from opengovern_connectors.ingestion.extractor.schema_util import avro_schema_to_mce_fields
from opengovern_connectors.metadata.com.linkedin.pegasus2avro.schema import SchemaField
from opengovern_connectors.metadata.schema_classes import NullTypeClass, SchemaFieldDataTypeClass
...
def get_schema_fields_for_sqlalchemy_column(
    ...
    This function is analogous to `get_schema_fields_for_hive_column` from opengovern_connectors.utilities.hive_schema_to_avro.
